...
<body>
	...
	<nav class="navbar navbar-expand-md bg-dark navbar-dark fixed-top">
	    	<img src="logo2.png" width="100px" height="80px">
		<a href="" class="navbar-brand text-warning font-weight-bold text-red" >Indian Spice</a>
...
<div class="container">    
	...
	<?php
		...
		<div class="col-lg-3 col-md-3 col-sm-6 ">	   
			<div class="card-deck">
				<div class="card p-1">
					<img src="<?php echo $row['image'];?>  " class="card-img-top" height="250">
			...
			<form class="form-submit" method="POST" action="action2.php?action=add&id=<?php echo $row['id'];?>">
				...
				<label style="font-size:20px">Qty</label><input style="width:30px" type="number" name="pqty"  size="1" value="1">
				<input type="submit" class="btn btn-info  addTocart" name="add_to_cart" value="Add to Cart">
			</form>
			</div>
			</div>
		</div>
