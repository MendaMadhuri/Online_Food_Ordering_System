...
<div class="container">    
	...
	<?php
		...
		<div class="mt-5 col-md-4">	   
			...
			<form class="form-submit" method="POST" action="lunch2.php?action=add&id=<?php echo $row['Product_ID'];?>">
				<input type="hidden" name="product_id" value="<?php echo $row['Product_ID'];?>"/>
				<input type="hidden" name="product_name" value="<?php echo $row['Product_Name'];?>"/>
				<input type="hidden" name="product_image" value="<?php echo $row['Product_Image'];?>"/>
				<input type="hidden" name="product_cost" value="<?php echo $row['Product_Cost'];?>"/>
				<label style="font-size:20px">Qty</label><input id='qty'name='pqty' TYPE="NUMBER" MIN="0" MAX="10" STEP="1" VALUE="0"/>
